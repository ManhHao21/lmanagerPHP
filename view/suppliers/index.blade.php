                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Quản lý  nhà cung cấp</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/" class="breadcrumb-link">Trang chủ</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">
                                            <a href="/admin/supplier" class="breadcrumb-link">Quản lý nhà cung cấp</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                ...
                <div class="row">
                    <div class="card w-100">
                        <div class="card-header flex">
                            <form method="GET" action="/admin/supplier" class="mb-3">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" name="keyword" class="form-control"
                                            placeholder="Tìm theo tên nhà cung cấp" value="{{ $keyword }}">
                                    </div>
                                    <div class="col-md-3">
                                        <button type="submit" class="btn btn-primary">Tìm kiếm</button>
                                        <a href="/admin/supplier" class="btn btn-warning">Reset</a>
                                    </div>
                                </div>
                            </form>
                            <a href="/admin/supplier/create" class="btn btn-primary flex justify-content-end">Thêm nhà cung cấp</a>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($suppliers as $index => $supplier)
                                            <tr>
                                                ...
                                                <td>{{ date('d-m-Y', strtotime($supplier['update_at'])) }}</td>
                                                <td>
